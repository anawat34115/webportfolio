  ...
  return <div className='min-h-[50vh] lg:min-h-[89vh] flex items-center' id='home'>
    <div className="container mx-auto px-9">
      ...
      <div className='mb-6 text-[36px] lg:text-[60px] font-secondary font-semibold uppercase leading-[1]'>
        ...
        <p className='mb-8 max-w-lg mx-auto lg:mx-0 text-black ss:text-[30px]'>นักพัฒนาเว็ปไซต์ด้วยประสบการณ์มากกว่า 2 ปี งาน fontend หรือการทำเว็ปLanding page เป็นสิ่งที่ผมถนัดมาก</p>
